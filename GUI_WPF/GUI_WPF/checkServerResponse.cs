...
namespace GUI_WPF
{
    public class checkServerResponse
    {
        ...
        private string _succededOrNotText;
        public string succededOrNot
        {
            get { return _succededOrNotText; }
            set { _succededOrNotText = value;}
        }
        public void checkIfLoginSucceded()
        {
            ...
            {
                //case Status.STATUS_USER_DOESNT_EXIST:
                   // _succededOrNotText = "user doest exist.";
            }
        }
    }
}
